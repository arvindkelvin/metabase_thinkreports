...
# Thinkreport's Design System

Welcome to the nascent documentation for Thinkreport's design system.

## Overview

Thinkreport's design system is going to be built on top of [Mantine](https://mantine.dev) and [React](https://reactjs.org/). Mantine is a React component library that provides a set of accessible, reusable, and composable components that can be used to build UIs.
